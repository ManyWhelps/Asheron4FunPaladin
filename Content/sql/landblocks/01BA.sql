...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701BA024, 4000090, 0x01BA018C, 72.86825, -61.273376, 0.004999995, 0.9508972, 0, 0, 0.3095068, False, '2021-10-05 22:44:37'); /* Archeologist Magmin */
/* @teleloc 0x01BA018C [72.868248 -61.273376 0.005000] 0.950897 0.000000 0.000000 0.309507 */
