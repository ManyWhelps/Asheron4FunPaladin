DELETE FROM `ace_world`.`landblock_instance` WHERE landblock=7 AND weenie_Class_Id=4218;
DELETE FROM `ace_world`.`landblock_instance` WHERE landblock=7 AND weenie_Class_Id=7194;
DELETE FROM `ace_world`.`landblock_instance` WHERE landblock=7 AND weenie_Class_Id=1595;

INSERT INTO `ace_world`.`landblock_instance` (guid,weenie_Class_Id, obj_Cell_Id, origin_X, origin_Y, origin_Z, angles_W, angles_X, angles_Y, angles_Z, is_Link_Child, last_Modified)
