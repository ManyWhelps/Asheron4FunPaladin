...
VALUES (4000067,   1,   33554773) /* Setup */
     , (4000067,   3,  536870932) /* SoundTable */
     , (4000067,   8,  100667503) /* Icon */
     , (4000067,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (4000067, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (4000067, 0, 4294967295, 'Menacing letter', 'Edward Hill', False, 'Thursday, July 14 
