...
VALUES (4000056,   1, 0x02000155) /* Setup */
     , (4000056,   3, 0x20000014) /* SoundTable */
     , (4000056,   8, 0x0600106F) /* Icon */
     , (4000056,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (4000056, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (4000056, 0, 0xFFFFFFFF, 'Glenden Wood Letter', 'Edward Hill', False, 'Sunday, July 10. 
