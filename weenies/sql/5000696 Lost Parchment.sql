...
VALUES (5000696,   1, 0x02000155) /* Setup */
     , (5000696,   3, 0x20000014) /* SoundTable */
     , (5000696,   8, 0x06001310) /* Icon */
     , (5000696,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5000696, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000696, 1, 0xFFFFFFFF, '', 'prewritten', False, 'A small exert from the Memoirs of H Calder.
