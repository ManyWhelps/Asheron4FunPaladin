...
VALUES (4000082,   1, 0x02000155) /* Setup */
     , (4000082,   3, 0x20000014) /* SoundTable */
     , (4000082,   8, 0x0600106F) /* Icon */
     , (4000082,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (4000082, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (4000082, 0, 0xFFFFFFFF, 'Saadia''s letter', 'Edward Hill', False, 'Tuesday, July 19 
