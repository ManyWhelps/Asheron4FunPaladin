...
VALUES (5000316,   1, 0x02000153) /* Setup */
     , (5000316,   3, 0x20000014) /* SoundTable */
     , (5000316,   8, 0x060012D5) /* Icon */
     , (5000316,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5000316, 50, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 0, 0xFFFFFFFF, '', 'prewritten', False, 'The first few dozen pages have been ripped out jagged tears mark their removal from the book, the first entry after that is in a handwritten scrawl.')
     , (5000316, 1, 0xFFFFFFFF, '', 'prewritten', False, 'Company Log -Under Command of Will Bounder, Captain
...
')
     , (5000316, 6, 0xFFFFFFFF, '', 'prewritten', False, ' There were whispers and looks; but none moved; none save Captain Bounder. He looked at us, walked through our number, Verily it was as if he could see into our souls in that moment. The calls of the Noble drowned away as the Captain approached him and dropped the purse containing the payment at his feet. ')
     , (5000316, 7, 0xFFFFFFFF, '', 'prewritten', False, ' I truthfully do not know what he said to us, only of the two things that followed, The Nobleman’s Guard moved toward the Captain, and in minutes they were all slain. And for the first time in six long years we were welcomed into a town as friends.
It is sure that the Nobles will seek revenge, but for now it feels like things have changed for us.
')
     , (5000316, 8, 0xFFFFFFFF, '', 'prewritten', False, ' 1281 RC Leafcull
...
')
     , (5000316, 9, 0xFFFFFFFF, '', 'prewritten', False, ' Those who went on supply runs have heard rumors, and not ones to ignore. The other Nobles will come for us upon the first thaw, we must be ready or gone. I fear what that will mean for the people here.')
     , (5000316, 10, 0xFFFFFFFF, '', 'prewritten', False, ' 1281 RC Snowreap
Winter has set in in full force. But we were well stocked for it. Baring minor issues it looks like we will get through the winter unscathed. The real concern on the Horizon now is the looming threat that will come with the Thaw. We have sent out some of our number to gather more intelligence, but the roads are treacherous, and travel is slow. We can only hope for their safe return and good News.')
     , (5000316, 11, 0xFFFFFFFF, '', 'prewritten', False, ' 1281 RC Wintersebb
...
')
     , (5000316, 12, 0xFFFFFFFF, '', 'prewritten', False, ' I am not the only one thinking the same. My comrades can hardly smile, looking knowingly into each other’s eyes and marking the losses we have already taken. The Captain has been quiet. But we know the look in his eyes as well as he knows ours. ')
     , (5000316, 13, 0xFFFFFFFF, '', 'prewritten', False, ' 1281 RC Morningthaw
...
')
     , (5000316, 15, 0xFFFFFFFF, '', 'prewritten', False, ' 1281 RC Seedsow 
...
')
     , (5000316, 16, 0xFFFFFFFF, '', 'prewritten', False, ' 1281 RC Leafdawning
...
')
     , (5000316, 17, 0xFFFFFFFF, '', 'prewritten', False, ' We have lost some to the fight as well, more native to the town then our seasoned fighters. Two of the Elders sought to make an agreement with the Nobles, and with their heads on pikes the town is looking more to the Captain for leadership now. 
...
')
     , (5000316, 18, 0xFFFFFFFF, '', 'prewritten', False, ' The pages here are faded to illegible to read.')
     , (5000316, 19, 0xFFFFFFFF, '', 'prewritten', False, ' 1282 RC Solclaim
...
')
     , (5000316, 20, 0xFFFFFFFF, '', 'prewritten', False, 'I don’t even know how many of us are left anymore. Once hell broke loose and we had to flee there was little we could do. We have lost so many. Less then 1500 Still travel with us. And probably half of the company remains. 
We are hounded every step of the way, our rear guard soaking up assault after Assault. 
')
     , (5000316, 21, 0xFFFFFFFF, '', 'prewritten', False, ' The script changes slightly, a more practiced hand perhaps.')
     , (5000316, 22, 0xFFFFFFFF, '', 'prewritten', False, ' Company Log -Under Command of Will Bounder, Captain 16th Company
Recorded By K Skye
1282 RC Seedsow
...
')
     , (5000316, 23, 0xFFFFFFFF, '', 'prewritten', False, ' 1131 refugees from town have survived the journey. And 241 still answer to the Company. We have started fortifications and stockpiling of supplies as well as rationing. Any name of note among us has had a price put upon their heads, though we are all Targets.')
     , (5000316, 24, 0xFFFFFFFF, '', 'prewritten', False, '1282 RC Thistledown
...
')
     , (5000316, 25, 0xFFFFFFFF, '', 'prewritten', False, ' A few soldiers of the company have taken spouses with the refugees or adopted the orphaned children as their own. We look more like a rag tag traveler company then a fighting machine to me. 
Still the supplies level is high and we are safe.
')
     , (5000316, 26, 0xFFFFFFFF, '', 'prewritten', False, ' -Damage to the pages over time')
     , (5000316, 27, 0xFFFFFFFF, '', 'prewritten', False, '1283 RC Snowreap
...
')
     , (5000316, 28, 0xFFFFFFFF, '', 'prewritten', False, ' -Damage to the pages over time')
     , (5000316, 29, 0xFFFFFFFF, '', 'prewritten', False, ' 1283 RC Verdantine
);
...
')
     , (5000316, 30, 0xFFFFFFFF, '', 'prewritten', False, ' 
1283 RC Thistledown
...
')
     , (5000316, 31, 0xFFFFFFFF, '', 'prewritten', False, ' 1283 RC Thistledown
...
')
     , (5000316, 32, 0xFFFFFFFF, '', 'prewritten', False, ' 1283 RC Thistledown
...
')
     , (5000316, 33, 0xFFFFFFFF, '', 'prewritten', False, ' -The Script changes, a scratchy scrawl but carefully written note on the Page')
     , (5000316, 34, 0xFFFFFFFF, '', 'prewritten', False, ' 1283 RC Thistledown
