...
VALUES (5000971,   1, 0x02000041) /* Setup */
     , (5000971,   2, 0x090000AE) /* MotionTable */
     , (5000971,   3, 0x20000014) /* SoundTable */
     , (5000971,   6, 0x040009B2) /* PaletteBase */
     , (5000971,   7, 0x10000336) /* ClothingBase */
     , (5000971,   8, 0x06001227) /* Icon */
     , (5000971,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5000971, 3, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000971, 0, 0xFFFFFFFF, 'The Council of Sages', 'prewritten', False, 'Levistras, the Speaker of the New Directive, was a rogue Virindi Director who sought to create a New Singularity in Dereth.
...
')
     , (5000971, 1, 0xFFFFFFFF, 'The Council of Sages', 'prewritten', False, 'The resulting war between their minions and Virindi forces loyal to the Singularity nearly destroyed Isparian civilization on Dereth. The Singularity sought to wipe Dereth clean of life to ensure that this never occurred again, and the New Directive''s goal of creating a New Singularity would have destroyed Dereth as we know it.
')
     , (5000971, 2, 0xFFFFFFFF, 'The Council of Sages', 'prewritten', False, 'In the end, the Virindi were no match for Isparian strength. With the assistance of Ecorto, the Lost Director, Isparians stormed the Seat of the New Singularity and slew Levistras. 
