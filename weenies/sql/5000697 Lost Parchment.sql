...
VALUES (5000697,   1, 0x02000155) /* Setup */
     , (5000697,   3, 0x20000014) /* SoundTable */
     , (5000697,   8, 0x06001310) /* Icon */
     , (5000697,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5000697, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000697, 1, 0xFFFFFFFF, '', 'prewritten', False, 'This note is charred with bits of blood, almost looking as if it was written by a child.
